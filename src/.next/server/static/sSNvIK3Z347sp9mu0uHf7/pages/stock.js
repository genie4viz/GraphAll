...
function (_Component) {
  ...
  Object(createClass["a" /* default */])(Bars, [{
    ...
    value: function drawBar() {
      ...
      external_d3_["select"](this.el).append('rect').attr('x', -r_bar_width / 2).attr('y', -greybarHeight).attr('width', r_bar_width).attr('height', greybarHeight).style('fill', '#bdbbbc');
      external_d3_["select"](this.el).append('rect').attr('x', -r_bar_width / 2).attr('y', -(greybarHeight + redbarHeight) + 5).attr('width', r_bar_width).attr('height', redbarHeight - 5).style('fill', '#df072c'); //round

      external_d3_["select"](this.el).append('rect').attr('rx', 5).attr('ry', 5).attr('x', -r_bar_width / 2).attr('y', -(greybarHeight + redbarHeight)).attr('width', r_bar_width).attr('height', redbarHeight).style('fill', '#df072c');
