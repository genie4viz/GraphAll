...
function (_Component) {
  ...
  Object(createClass["a" /* default */])(Bars, [{
    ...
    value: function drawBar() {
      ...
      external_d3_["select"](".greybar").transition().duration(1000).attr('x', -r_bar_width / 2).attr('y', -greybarHeight).attr('width', r_bar_width).attr('height', greybarHeight).style('fill', '#bdbbbc');
